...
enum AppCapabilities {
	...
	AppCapabilities1 = 1,
	AppCapabilitiesLast = AppCapabilities1
};
 ...
 */
extern "C" [[maybe_unused]] long GetClassObject ( const WCHAR_T*, IComponentBase** pIntf );
extern "C" long DestroyObject ( IComponentBase** pIntf );
extern "C" const WCHAR_T* GetClassNames ();
extern "C" AppCapabilities SetPlatformCapabilities ( AppCapabilities capabilities );
...
typedef AppCapabilities (* SetPlatformCapabilitiesPtr) ( AppCapabilities capabilities );
